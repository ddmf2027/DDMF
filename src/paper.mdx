...
<Header
  title="Learning Disentangled Robot Skills for Diverse Action Generation via Diversified Disentangled Metric Flow"
  conference="Conference Name"
  authors={[
    {
      name: "Author Names Omitted for Anonymous Review. Paper-ID [2756]",
    },
  ...
  links={[
    ...
    { name: "Code", url: "https://github.com/ddmf2027/DDMF", icon: "ri:github-line" },
    { name: "Supplementary", url: "./supplementary/DDMF_supplementary.pdf", icon: "ri:file-pdf-2-line" },
  ]}
>
  {/*
